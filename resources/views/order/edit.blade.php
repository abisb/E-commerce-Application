                    ...
                    <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                    <form action="{{route('order.update')}}" method="POST" enctype="multipart/form-data" id="order_form">
                                             @csrf
                                             @if(@$order->id)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="customer_name" type="text" class="form-control" placeholder="Enter customer name" required=""  value="{{@$order->customer_name}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="phone" class="col-form-label">Phone Number</label>
                                                <input name="phone" type="text" class="form-control" placeholder="Enter Phone Number" required="" value="{{@$order->phone}}" >
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value="{{$prod->id}}" @if($prod->id==$value->product_id) selected @endif>{{$prod->product_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="quantity[]" type="number" class="form-control" name="quantity" required="" value="{{$value->quantity}}" min="1" >
                                        </div>
                                        @endforeach
